...
const TITLE_TEXT = {
  ...
  TITLE_15: '공고 수정이 완료되었습니다.',
  TITLE_16: '최소한의 정보 입력으로 바로 시작!',
  TITLE_17: '본인인증 후 서비스 등록이 가능합니다.',
  TITLE_18: '해당 공고를 복사하시겠습니까?',
  TITLE_19: '회원 탈퇴를 위해 본인 인증이 필요합니다.',
  TITLE_20: '정말 탈퇴하시겠습니까?',
  TITLE_21: '해당 공고는 무료로 등록됩니다. \n 공고 등록을 진행하시겠습니까?',
  TITLE_22: '로그인이 필요한 서비스입니다.',
  TITLE_23: '이력서를 작성하려면 본인인증이 필요해요',
  TITLE_24: '가입된 이메일로 인증 메일을 발송했습니다. \n 이메일을 확인해주세요.',
} as const;
...
const DESCRIPTION_TEXT = {
  ...
  DESC_6: '지금 본인인증 하시겠습니까?',
  DESC_7: '이력서를 삭제해도 기존 입사지원내역은 유지됩니다.',
  DESC_8: '계정을 삭제하면 등록된 정보와 이력이 모두 삭제되며 복구가 불가능합니다.\n 신중하게 결정해주세요.',
  DESC_9: '최대 10분 이내에 채용공고 페이지에 반영됩니다.',
  DESC_10: '채용공고 목록으로 이동하시겠습니까?',
  ...
  DESC_15: '로그인 페이지로 이동할까요?',
  DESC_16: '간단한 인증으로 이력서 작성을 시작할 수 있어요. \n 진행하시겠어요?',
  DESC_17: '가입된 정보가 없습니다. \n 다시 확인해주세요.',
  DESC_18: '브라우저를 유지해주세요. 인증 완료되면 자동으로 이동합니다.',
};
