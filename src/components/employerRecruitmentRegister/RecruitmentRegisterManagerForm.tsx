  ...
  return (
    <S.RecruitmentRegisterManagerForm>
      <HorizontalFormWrapper>
        <FormInputB<any> required label="담당자명" name="a" placeholder="담당자명" maxWidth="400px" />
        <FormCheckbox label="비공개" name="담당자명" visibleIcon={false} margin="0 0 0 15px" />
      </HorizontalFormWrapper>

      <HorizontalFormWrapper>
        <FormInputB<any> required label="연락처" name="a" placeholder="연락처" maxWidth="400px" />
        <FormCheckbox label="비공개" name="연락처" visibleIcon={false} margin="0 0 0 15px" />
      </HorizontalFormWrapper>

      <HorizontalFormWrapper>
        <FormInputB<any> required label="이메일" name="a" placeholder="이메일" maxWidth="400px" />
