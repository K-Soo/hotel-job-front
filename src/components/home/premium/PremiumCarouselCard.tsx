...
interface PremiumCarouselCardProps {
...
export default function PremiumCarouselCard({ item, index }: PremiumCarouselCardProps) {
...
const S = {
  PremiumCarouselCard: styled(motion.div)<{ index: number }>`
    ${({ index }) => {
