...
export default function PolicyPrivacy({}: PolicyPrivacyProps) {
  return (
    <S.PolicyPrivacy>
      <S.Section>
        ...
        <S.Content>
          <p>
            호텔잡(이하 “회사”)는 「신용정보의 이용 및 보호에 관한 법률」, 「전자금융거래법」, 「전자상거래법」, 「정보통신망 이용촉진 및
            정보보호 등에 관한 법률」, 「개인정보 보호법」, 「특정 금융거래정보의 보고 및 이용 등에 관한 법률」 등 관련 법규에 따라 이용자의
            개인(신용)정보를 보호하고 개인(신용)정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리방침을
            수립‧공개합니다.
          </p>
          <br />
        </S.Content>
      ...
      <S.Section>
        ...
        <S.Content>
          ...
          <table>
            <caption style={{ textAlign: 'left' }}>일반 회원 및 외국인 회원</caption>
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <td>간편가입 및 로그인</td>
                <td>(필수)카카오: 아이디, 이름, 이메일</td>
                <td>
                  회원 가입 및 관리, 상품 구매 및 결제, 공지사항 및 회원 설정 기반 정보 제공, 서비스 이용 또는 콘텐츠 활용 관련 사용자 출처
                  표시, 서비스 제공을 위한 업무의 처리 ※ 당사는 고객의 편의를 위해 간편 로그인(네이버, 카카오, 페이스북, 구글, Apple) 방식을
                  제공하고 있습니다. 이와 같은 로그인시 당사가 고객의 개인정보를 추가 수집하지 않으며, 본인확인값만 비교하고 있습니다.
                </td>
                <td>회원탈퇴 시</td>
              </tr>
              <tr>
      ...
      <S.Section>
        ...
        <S.Content>
          ...
          <p>가. 조회 및 수정</p>
          <p>
            개인 : 홈페이지의 「MY PAGE {'>'} 계정정보 설정」 및 「MY PAGE {'>'} 내 이력서 관리」기능을 통해 개인정보를 조회 · 수정할 수
            있습니다.
          </p>
          ...
          <p>나. 회원탈퇴</p>
          <p>
            개인 : 홈페이지의 「고객센터 {'>'} 개인회원 탈퇴」기능을 통해 개인정보를 삭제할 수 있으며, 회원 탈퇴 즉시 보유 중인 이력서도
            삭제처리 됩니다.
          </p>
          <p>
            기업 : 홈페이지의 「고객센터 {'>'} 개인회원 탈퇴」기능을 통해 개인정보를 삭제할 수 있으며, 회원 탈퇴 즉시 보유 중인 이력서도
            삭제처리 됩니다.
          </p>
